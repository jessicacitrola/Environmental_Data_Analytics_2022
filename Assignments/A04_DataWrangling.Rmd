...
class(EPA.PM.2018$Date)
EPA.PM.2018$Date <- mdy(EPA.PM.2018$Date)
class(EPA.PM.2018$Date)

class(EPA.PM.2019$Date)
...
write.csv(EPA.O3.2018.select, row.names = FALSE, 
          file = "/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_NC2018_processed.csv")

write.csv(EPA.O3.2019.select, row.names = FALSE, 
          file = "/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_NC2019_processed.csv")

write.csv(EPA.PM.2018.select, row.names = FALSE, 
          file = "/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_PM25_NC2018_processed.csv")

write.csv(EPA.PM.2019.select, row.names = FALSE, 
          file = "/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_PM25_NC2019_processed.csv")
...
#O3.2018 <- read.csv("/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_NC2018_processed.csv",stringsAsFactors = TRUE)

#O3.2019 <- read.csv("/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_NC2019_processed.csv",stringsAsFactors = TRUE)

#PM.2018 <- read.csv("/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_PM25_NC2018_processed.csv", stringsAsFactors = TRUE)

#PM.2019 <- read.csv("/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_PM25_NC2019_processed.csv", stringsAsFactors = TRUE)

O3.PM.Combined <- rbind(EPA.O3.2018.select , EPA.O3.2019.select, EPA.PM.2018.select, EPA.PM.2019.select)

#8

is.POSIXlt(O3.PM.Combined$Date)
...
O3.PM.Updated.Spread <- pivot_wider(O3.PM.Updated, names_from = AQS_PARAMETER_DESC, values_from = meanAQI) 


#10

dim(O3.PM.Updated.Spread)

#11

write.csv(O3.PM.Updated.Spread, row.names = FALSE, 
          file = "/Users/jessicacitrola/Documents/ENV872/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
...
O3.PM.summary <- 
  O3.PM.Updated.Spread %>%
  group_by(Site.Name, Month, Year) %>%
  filter(!is.na(PM2.5) & !is.na(Ozone)) %>%
  summarise(meanAQI.PM = mean(PM2.5), 
